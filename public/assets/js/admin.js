    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            const parentRow = link.closest('tr');
                         console.log("Script loaded",'/admin#' + pageId);
...
//     // Map data-page → router URL
//     const routeMap = {
//         'dashboard': '/admin',
//         'classes': '/admin/class',
//         'students': '/admin/student',
//         'admins': '/admin/admin',
//         'elections': '/admin/election',
//         'winners': '/admin/winner',
//         'analytics': '/admin' // adjust if you create /admin/analytics later
//     };
...
//             const pageId = link.getAttribute('data-page');
//             const targetUrl = routeMap[pageId] || '/admin';

//             console.log("Page ID:", pageId);
//             console.log("Navigating to:", targetUrl);

//             // Navigate to proper server route
//             window.location.href = targetUrl;

//             // Update page content only if it's a single-page style dashboard
//             if (pages.length > 0) {
//                 pages.forEach(p => p.classList.remove('active'));
//                 const page = document.getElementById(pageId);
//                 if (page) {
